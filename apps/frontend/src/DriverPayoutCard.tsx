...
/**
 * Demonstrates the planned driver-payout experience. The production version
 * must render server-confirmed payment events rather than this local timeline.
 */
            ...
            <div className="flex items-center gap-3.5">
                    ...
                    >
                        {state === "sending" ? (
                            <Loader2
                                size={22}
                                strokeWidth={1.75}
                                className="animate-spin text-[#002B49]"
                            />
                        ) : (
                            <PartyPopper
                                size={22}
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {state === "sending"
                                ? "Simulating delivery bonus transfer…"
                                : `Demo bonus of ${amount} marked paid`}
                        </m.p>
                    </AnimatePresence>
                </div>
