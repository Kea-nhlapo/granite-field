    ...
    return (
        <SectionCard className="p-4">
            ...
            <p className="app-caption text-[#595959] mb-3">
                Priced live against your MoMo Network Trust Index — the higher
                your score, the lower your premium.
            </p>
...
function FactorRow({
    ...
    h: (typeof COMPLIANCE_FACTORS)[number];
    bordered?: boolean;
}) {
    return (
        <div
            className={`flex gap-3 p-3.5 items-start ${bordered ? "border-b border-[#E5E7EB]" : ""}`}
        >
            <div
            ...
            <>
                ...
                >
                    ...
                    <SectionCard className="p-6 text-center bg-white border border-[#E5E7EB]">
                        <p className="app-overline">MoMo Network Trust Index</p>
                        <div className="flex items-center justify-center gap-1 my-2">
                            <span className="app-metric-hero">91</span>
                            <span className="text-xl text-[#8E8E93] font-light">
                                /100
                            </span>
                        </div>
                        <div className="flex items-center justify-center gap-2">
                            <Badge
                                label="Tier-1 Verified Node"
                                color="success"
                            />
            ...
            <div className="grid grid-cols-2 gap-2.5">
                {[
                    ...
                    >
                        ...
                        <p className="app-heading mt-0.5">{s.label}</p>
                    ...
                    <SectionCard className="p-4 space-y-3">
                        {[
                            ...
                            <div key={x.r} className="flex items-center gap-3">
                                <span className="app-caption text-[#595959] flex-1 truncate">
                                    {x.r}
                                </span>
        ...
        <>
            ...
            >
                ...
                <div className="flex flex-col items-center py-4 text-center">
                    ...
                    <h2 className="app-title mt-2">Mama Nkosi Spaza Supply</h2>
                    <p className="app-caption text-[#595959]">
                        Soweto Node #7412 • Member since Jan 2025
                    </p>
                    <div className="mt-2">
                        <Badge
                            label="MoMo Trust: 91/100 (Prime)"
                            color="success"
                        />
                    </div>
                </div>
                ...
                <SectionCard>
                    {internal && (
                        <div className="flex items-center justify-between p-3.5 border-b border-[#E5E7EB]">
                            <div>
                                ...
                                <p className="app-caption text-[#595959]">
                                    Internal risk access granted by your account
                                    role
                                </p>
                            </div>
                            <Badge label="Authorised" color="brand" />
                        </div>
                    )}
                    ...
                    {[
                        ...
                        {
                            label: "Payment Settlement Rail",
                            value: "MoMo PSB Settlement Gate",
                        },
                        {
                            label: "Underwriting Class",
                            value: "Transit Security Tier 2",
                        },
                        {
                            label: "Cloud Region",
                            value: "AWS Africa (Cape Town) — af-south-1",
                        },
                    ].map((r, i, arr) => (
                        <div
                            key={r.label}
                ...
                <p className="app-micro text-center pt-2">
                    Powered by{" "}
                    <strong className="text-[#003E85]">MoMo PSB</strong> •
                    TradeMesh Enterprise SCM
                </p>
            </div>
        </>
    );
