...
export function Badge({
  ...
  const styles: Record<BadgeColor, { bg: string; text: string; border: string; dot: string }> = {
    green: { bg: "#E3FCEF", text: "#00875A", border: "#A3E7C9", dot: "#00875A" },
    success: { bg: "#E3FCEF", text: "#00875A", border: "#A3E7C9", dot: "#00875A" },
    amber: { bg: "#FFF3E0", text: "#D96B00", border: "#FFE0B2", dot: "#F57C00" },
    warning: { bg: "#FFF3E0", text: "#D96B00", border: "#FFE0B2", dot: "#F57C00" },
    red: { bg: "#FDE8E8", text: "#D32F2F", border: "#F8B4B4", dot: "#D32F2F" },
    danger: { bg: "#FDE8E8", text: "#D32F2F", border: "#F8B4B4", dot: "#D32F2F" },
    blue: { bg: "#EBF3FC", text: "#003E85", border: "#C7E0F4", dot: "#003E85" },
    brand: { bg: "#EBF3FC", text: "#003E85", border: "#C7E0F4", dot: "#003E85" },
    grey: { bg: "#F3F4F6", text: "#595959", border: "#E5E7EB", dot: "#8E8E93" },
    neutral: { bg: "#F3F4F6", text: "#595959", border: "#E5E7EB", dot: "#8E8E93" },
    navy: { bg: "#002B49", text: "#FFCC00", border: "#001F35", dot: "#FFCC00" },
    yellow: { bg: "#FFF9D6", text: "#7A6000", border: "#FFE082", dot: "#FFCC00" },
  };
...
export function PrimaryBtn({
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: disabled ? "var(--momo-grey-inactive, #CCCCCC)" : "var(--momo-yellow, #FFCC00)",
        color: disabled ? "var(--momo-grey-inactive-text, #8E8E93)" : "var(--momo-navy, #002B49)",
...
export function PrimaryBlueBtn({
  ...
  return (
    <button
      ...
      style={{
        backgroundColor: disabled ? "var(--momo-grey-inactive, #CCCCCC)" : "var(--momo-blue, #003E85)",
        color: disabled ? "var(--momo-grey-inactive-text, #8E8E93)" : "#FFFFFF",
        border: "1px solid transparent",
        cursor: disabled ? "not-allowed" : "pointer",
        borderRadius: "var(--fluent-radius-md, 8px)",
      }}
...
export function SecondaryBtn({
  ...
  return (
    <button
      ...
      style={{
        borderColor: disabled ? "var(--momo-grey-inactive, #CCCCCC)" : "var(--momo-blue, #003E85)",
        borderWidth: "1.5px",
        color: disabled ? "var(--momo-grey-inactive-text, #8E8E93)" : "var(--momo-blue, #003E85)",
        cursor: disabled ? "not-allowed" : "pointer",
        borderRadius: "var(--fluent-radius-md, 8px)",
      }}
    >
  ...
  return (
    <div
      ...
      className={`bg-white border rounded-xl transition-all ${
        onClick ? "cursor-pointer hover:border-[#003E85] active:bg-[#F8F9FA]" : ""
      } ${className}`}
      style={{
        borderColor: "var(--fluent-stroke-card, #E5E7EB)",
        borderRadius: "var(--fluent-radius-lg, 12px)",
        boxShadow: "var(--fluent-depth-card, 0 2px 8px rgba(0, 0, 0, 0.05))",
        ...style,
      }}
    >
      {children}
...
export function PersonaCoin({
  ...
  return (
    <div
      onClick={onClick}
      className={`relative flex items-center justify-center font-bold rounded-full select-none ${
...
export function MessageBar({
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 text-[#1A1A1A] leading-relaxed">{children}</div>
      ...
      {TABS.map((t) => {
        ...
        return (
          <button
            ...
            style={{
              color: isActive ? "var(--momo-navy, #002B49)" : "rgba(0, 43, 73, 0.65)",
            }}
          >
            ...
            {isActive && (
              <span
                ...
                style={{ backgroundColor: "var(--momo-navy, #002B49)" }}
              />
            )}
