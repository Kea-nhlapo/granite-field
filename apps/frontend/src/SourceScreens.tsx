            ...
            >
                <SectionCard className="p-4">
                    ...
                    <p className="app-body text-[#595959] leading-relaxed">
                        Invite suppliers to submit invoices and order manifests
                        directly. No account registration is required for
                        them—documents are parsed and validated against your
                        MoMo purchasing tolerances instantly.
                    </p>
                </SectionCard>
                ...
                {generated && (
                    <SectionCard className="p-4">
                        ...
                        <p className="app-micro mt-2">
                            Single-use MoMo escrow token • Automatically expires
                            in 72 hours
                        </p>
                    </SectionCard>
                )}
