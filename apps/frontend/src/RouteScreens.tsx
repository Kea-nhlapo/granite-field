...
import { ChevronRightIcon, TruckIcon } from "./icons";
    ...
    return (
        <>
            ...
            >
                {/* Matched Carrier */}
                <div>
                    <p className="app-overline mb-2">Matched Fleet Carrier</p>
                        ...
                        {[
                            ...
                            >
                                ...
                                <div className="flex-1 min-w-0">
                                    <p className="app-heading">{r.name}</p>
                                    <p className="app-caption text-[#595959]">
                                        {r.time} • {r.tag}
                                    </p>
                                </div>
...
export function RouteDetailScreen({
    ...
    const riskVerdict =
        data.hijack <= 30
            ...
            : data.hijack <= 55
              ? {
                    label: "Moderate incident risk — standard precautions apply",
                    color: "#F57C00",
                }
              : {
                    label: "Elevated incident risk on this corridor",
                    color: "#D32F2F",
                };
    ...
    return (
        <>
                        ...
                        {expanded && (
                            ...
                            >
                                <div className="px-4 pb-4">
                                    ...
                                    />
                                    <FactorRow
                                        label="MTN Telematics Coverage"
                                        score={data.coverage}
                                    />
                                    <FactorRow
                                        label="Pavement Quality"
                                        score={data.road}
                                    />
                                    <FactorRow
                                        ...
                                        score={Math.round(
                                            100 -
                                                (parseInt(data.fuel, 10) - 60) *
                                                    3,
                                        )}
                                    />

                                    <p className="app-overline mt-3 mb-1">
                                        Consignment Specification
                                    </p>
                                    <Row
                                        label="Cargo Classification"
                                        value="FMCG & Dry Groceries"
                                    />
                                    <Row
                                    ...
                                    <Row
                                        ...
                                        value="Standard MoMo GIT Escrow"
                                    />
                                    <Row
                                        label="Scheduled Dispatch"
                                        value="Today 16:00 SAST"
                                    />
                                </div>
                            </m.div>
                        )}
            ...
            <BottomDock>
                ...
                <SecondaryBtn
                    label="Review Alternate Corridor"
                    onClick={onBack}
                />
            </BottomDock>
        </>
